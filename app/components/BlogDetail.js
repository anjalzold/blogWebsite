            ...
            <div className='flex flex-col items-center justify-start w-full gap-[46px]'>
              <div className='flex flex-row justify-center w-full'>
                <div className='flex flex-col items-center justify-start w-full'>
                  ...
                  />
                  <div className='flex flex-col items-start justify-center w-[84%] mt-[-132px] p-12 bg-white shadow-lg rounded-[25px]'>
                    <Text
                      size='lg'
                      as='p'
                      className='mt-1 ml-4 text-black font-light'
                    >
                    ...
                    <Heading
                      size='2xl'
                      as='h1'
                      className='w-[97%] mt-[25px] ml-4 tracking-[0.12px] !font-merriweather italic text-teal-500'
                    >
                      ...
                      <div className='flex flex-row justify-start items-center w-[31%] gap-3.5'>
                        ...
                        <div className='flex flex-col items-start justify-start w-[72%] gap-0.5'>
                          <Heading
                            size='lg'
                            as='h2'
                            className='text-gray-600 text-center text-lg font-semibold'
                          >
                            By Jhone Leonardo
                          </Heading>
                          <Text
              ...
              <div className='flex flex-col items-start justify-start w-[74%]'>
                ...
                <div className='flex flex-col items-start justify-start w-[48%] mt-[27px] ml-[28px]  gap-3.5'>
                  <div className='flex flex-row justify-start items-center w-[61%] gap-[15px]'>
                    <div className='h-2.5 w-2.5 mt-[5px] bg-gray-600 rounded-[50%]' />
                    <Text as='p'>Lorem ipsum dolor sit amet.</Text>
                  </div>
                  <div className='flex flex-row justify-start items-center w-[92%] gap-[15px] '>
                    <div className='h-2.5 w-2.5 bg-gray-600 rounded-[50%] text-nowrap' />
                    <Text as='p' className="text-base">At vero eos et accusamus et iusto odio.</Text>
                  </div>
                  <div className='flex flex-row justify-start items-center w-[100%] gap-[15px] text-md '>
                    <div className='h-2.5 w-2.5 mt-[5px] bg-gray-600 rounded-[50%]' />
                    <Text as='p' className="">
                ...
                <div className='flex flex-row justify-start mt-3 gap-[15px]'>
                  <Button
                    ...
                    size='md'
                    shape='round'
                    className='font-thin min-w-[96px] text-gray-800'
                  >
                    Writing
                  </Button>
                  <Button
                    ...
                    size='md'
                    shape='round'
                    className='font-thin min-w-[97px]  text-gray-800'
                  >
                    Tutorial
                  </Button>
                  <Button
                    ...
                    size='md'
                    shape='round'
                    className='font-thin min-w-[93px]  text-gray-800'
                  >
                    How to
                  </Button>
                  <Button
                    ...
                    size='md'
                    shape='round'
                    className='font-thin min-w-[77px]  text-gray-800'
                  >
                    Book
                  </Button>
                  <Button
                  ...
                  <div className='flex flex-col items-end justify-start w-full gap-[30px]'>
                    ...
                    <div className='flex flex-row justify-start items-center w-[38%] mr-[168px] gap-[15px]'>
                      ...
                      <div className='flex flex-col items-start justify-start w-[68%] gap-[3px]'>
                        <Heading
                          as='h5'
                          className='text-blue-600 text-center font-semibold text-sm'
                        >
                          By Jhone Leonardo
                        </Heading>
