...
import BloggerDetailsPagination from "./BloggerDetailsPagination";
    ...
    <>
      ...
      <div className='flex flex-col items-center justify-start w-full bg-white-A700'>
        ...
        <div className='flex flex-col items-center justify-start w-full mt-10 gap-[97px]'>
            ...
            <div className='flex flex-col items-center justify-start w-full'>
              <div className='flex flex-row justify-center w-full bg-gray-600_01'>
                <div className='h-[525px] w-full relative'>
                  ...
                  />
                  <div className='flex flex-row justify-between items-center w-[78%] top-[11%] right-0 left-0 m-auto absolute'>
                    <div className='flex flex-col items-start justify-start w-[58%] gap-[25px]'>
                      ...
                      <div className='flex flex-row justify-start items-center w-[37%] gap-3.5'>
                        ...
                        <div className='flex flex-col items-start justify-start w-[69%] gap-[3px]'>
                          <Heading
                            as='h2'
                            className='!text-white-A700 tracking-[0.12px] text-center text-sm font-semibold'
                          >
                            By Jhone Leonardo
                          </Heading>
                          <Text
                    ...
                    <div className='flex flex-row justify-center w-[32%] p-8 bg-white-A700_3f rounded-[5px]'>
                      <div className='flex flex-col items-center justify-start w-full gap-6 my-[11px]'>
                        <Heading
                          size='lg'
                          as='h3'
                          className='!text-white-A700 tracking-[0.12px] !font-semibold'
                        >
                        ...
                        <div className='flex flex-row justify-between w-full'>
                          ...
                          />
                          <Img
                            src='images/img_spotify_1.svg'
                            alt='spotifyone_one'
                            className='h-[50px] w-[50px]'
                          />
                          <Img
                            src='images/img_podcast_1_1.svg'
                            alt='podcast1one_one'
                            className='h-[50px] w-[50px]'
                          />
                        </div>
              ...
              <div className='flex flex-row justify-center w-full mt-[-106px] p-[21px] bg-white-A700 shadow-2xl max-w-[920px] rounded-[5px]'>
                <div className='flex flex-row justify-start items-center w-full mt-2 ml-[5px] gap-[22px]'>
                  <Img
                  ...
                  <div className='flex flex-col items-start justify-start w-[74%]'>
                    <div className='flex flex-row justify-between items-center w-full'>
                      <Button
                        ...
                        size='xs'
                        shape='round'
                        className='font-light min-w-[74px]'
                      >
                        Writer
                      </Button>
                      <Text size='xs' as='p'>
                    ...
                    <Heading
                      as='h4'
                      className='mt-5 !text-gray-900 tracking-[0.12px] !font-merriweather italic'
                    >
                      Eps 3 : How to write a book properly and correctly by
                      paying attention to various parts to support the story
                    </Heading>
          ...
          <div className='flex flex-col items-start justify-start w-full max-w-[1106px]'>
            <div className='flex flex-row justify-start items-center w-2/5 gap-[18px]'>
              <Button color='gray_300_01' size='7xl' className='w-[76px]'>
              ...
              <div className='flex flex-col items-start justify-start w-[79%] gap-2'>
                ...
                <Text
                  size='lg'
                  as='p'
                  className='tracking-[0.12px] text-center'
                >
                  Get started on latest episodes
                </Text>
              </div>
            </div>
            <div className='w-full mt-[17px] gap-[22px] grid-cols-4 grid min-h-[auto]'>
              <div className='flex flex-col items-center justify-start w-full gap-[15px] p-[13px] bg-white-A700 shadow-md rounded-[5px]'>
                <div className='h-[207px] w-full relative'>
                  ...
                  />
                  <Button className='w-[72px] left-0 bottom-0 right-0 top-0 m-auto absolute'>
